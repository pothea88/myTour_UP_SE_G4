...
<tr><td class="lefttxt">Category Name</td><td><input type="text"   value="<?php if(isset($_POST["show"])){ echo $Cat_name ;} ?>" name="t2" required pattern="[a-zA-z _]{3,100}" title"Please Enter Only Characters between 3 to 10 for Category Name"/></td></tr> 
<!-- change fomart required of category  from 3 to 10 , 3 to 100 -->
