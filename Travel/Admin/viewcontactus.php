...
{
	$cn=makeconnection();
	$s="insert into contactus(Cat_name) values('" . $_POST["t1"] ."')";
	mysqli_query($cn,$s);
...
<tr><td class="toptd">View Contact us</td></tr>
...
<tr>
	...
	<td style="font-size:15px; padding:5px; font-weight:bold; with:70px;">Messages</td>
</tr>
...
while($data=mysqli_fetch_array($result))
{
        ...
        echo " <tr><td style=' padding: 5px; '>$data[0]</td><td style=' padding: 5px; '>$data[1]</td><td style=' padding: 5px; '>$data[2]</td>
		<td style=' padding: 5px; '>$data[3]</td><td style=' padding: 5px; '>$data[4]</td></tr>";
