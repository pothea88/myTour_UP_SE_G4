...
{
	$cn=makeconnection();
	$s="insert into users(Cat_name) values('" . $_POST["t1"] ."')";
	mysqli_query($cn,$s);
...
<tr><td style="font-size:15px; padding:5px; font-weight:bold;">UserName</td>
<td style="font-size:15px; padding:5px; font-weight:bold;">Password</td>
<td style="font-size:15px; padding:5px; font-weight:bold;">User type</td></tr>
